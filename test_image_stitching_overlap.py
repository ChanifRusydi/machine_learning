...
cv2.imshow('image1_70_left',image1_60_left)
cv2.imshow('image1_70_right',image1_60_right)
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.imwrite('image1_70_left.jpg',image1_60_left)
cv2.imwrite('image1_70_right.jpg',image1_60_right)
