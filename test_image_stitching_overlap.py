...
def plot_images(imgs, figsize_in_inches=(5,5)):
    ...
    plt.show()
image_file1 = 'traffic_image_ultrawide.jpg'
...
left_image = cv2.imread('image1_50_left.jpg')
right_image = cv2.imread('image1_50_right.jpg')
# stitching_image=cv2.Stitcher.create()
# status,stitched_image=stitching_image.stitch((left_image,right_image))
import stitching
settings = {"detector": "brisk", "confidence_threshold": 0.6}
stitcher = stitching.Stitcher(**settings)
panorama = stitcher.stitch(['image1_50_left.jpg', 'image1_50_right.jpg'])
plot_image(panorama)
# if status==0:
