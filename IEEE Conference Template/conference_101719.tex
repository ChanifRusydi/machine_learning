...
The dataset is divided into training set and testing set. The training set contains 800 images with 8,000 traffic objects. The testing set contains 200 images with 2,000 traffic objects. The dataset is available at \url
