...
Although each run iwth 8 epoch still takes about 1 to 2 hours, it is still better than running 100 epoch for each configuration.
We tried different batch size, learning rate, and optimizer. We use batch size 16 and 32.
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth,keepaspectratio]{mounted_camera_front_view.jpg} % TODO ; change file name
...
Therefore, we use batch size 32 for our training.
